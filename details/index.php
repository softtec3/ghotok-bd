...
<body>
  ...
  <!-- Action Buttons -->
  <div class="actions">
    <button class="btn primary"><i class="fas fa-heart"></i> Send Interest</button>
    <button class="btn secondary"><i class="fas fa-star"></i> Add to Favorites</button>
    <button class="btn info"><i class="fas fa-phone"></i> Contact</button>
    <button class="btn danger"><i class="fas fa-exclamation-triangle"></i> Report</button>
  </div>
