...
<body>
  ...
  <section class="hero">
    <div class="hero-content">
      ...
      <p>Your trusted matrimony platform to find the perfect life partner.</p>
      <a href="/matrimony/register" class="btn-primary">Register Now</a>
      <a href="/matrimony/login" class="btn-secondary">Login</a>
    </div>
...
<section class="testimonials">
  ...
  <div class="testimonial-list">
    ...
    <div class="testimonial">
      ...
      <div class="testimonial-text">
        <p>"Best matrimony site with genuine profiles. Highly recommend!"</p>
  ...
  <section class="cta">
    ...
    <a href="/matrimony/register" class="btn-primary">Create Free Account</a>
  </section>
  <footer class="footer">
    <div class="footer-container">
      <div class="footer-about">
        <h3>Ghotok-BD</h3>
        <p>
          Ghotok-BD is Bangladesh’s trusted matrimony platform helping brides and grooms
      ...
      <div class="footer-links">
        ...
        <ul>
          ...
          <li><a href="/matrimony/register">Register</a></li>
          <li><a href="/matrimony/login">Login</a></li>
          <li><a href="/matrimony/rules-regulations">Rules & Regulations</a></li>
        </ul>
      </div>
