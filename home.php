...
<body>
            ...
            <section class="buy-connects">
              ...
              <div class="plans">
                ...
                <div class="plan-card">
                  ...
                  <a href="#" onclick="handleBuyConnect('starter')" class="plan-btn">Buy Now</a>
                </div>
                ...
                <div class="plan-card">
                  ...
                  <a href="#" onclick="handleBuyConnect('mini')" class="plan-btn">Buy Now</a>
                </div>
                ...
                <div class="plan-card featured">
                  ...
                  <a href="#" onclick="handleBuyConnect('basic')" class="plan-btn">Buy Now</a>
                </div>
                ...
                <div class="plan-card">
                  ...
                  <a href="#" onclick="handleBuyConnect('pro')" class="plan-btn">Buy Now</a>
                </div>
                ...
                <div class="plan-card">
                  ...
                  <a href="#" onclick="handleBuyConnect('premium')" class="plan-btn">Buy Now</a>
                </div>
              </div>
            </section>
          </div>
    ...
    <div id="alert" style="display: <?php if (!empty($show_alert)) echo 'flex'; ?>;">
      <div class="alertContent">
        ...
        <form style="display: <?php
          ...
          <a href="#" onclick="handlePayOne('<?php if (isset($_GET['add_interested'])) echo $_GET['add_interested'] ?>')">Pay for one <?php if (isset($_GET["add_interested"])) echo $_GET["add_interested"] ?> </a>
        </form>
      </div>
    </div>
  ...
  <script>
    const handleBuyConnect = async (pack) => {
      let payAmount = 0;
      if (pack == "starter") {
        payAmount = "100"
      } else if (pack == "mini") {
